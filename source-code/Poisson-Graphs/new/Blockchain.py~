...
class Blockchain(object):
    ...
    def addBlock(self, blockToAdd, mode="Nakamoto", targetRate=1.0/600000.0):
        ...
        self.whichLeaf()
        return self.computeDifficulty(mode, targetRate)
    ...
    def computeDifficulty(self, mode="Nakamoto", targetRate=1.0/600000.0):
        result = None
        if mode=="Nakamoto":
            ...
            if len(self.blocks) < count:
                ...
                if not touched:
                    ...
                    if self.verbose:
                        print("Est disco rate = " + str(estDiscoRate) + " and targetRate = " + str(targetRate))
                ...
                # Update difficulty multiplicatively
                self.diff = self.diff*estDiscoRate/targetRate
